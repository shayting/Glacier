    ...
    <v-row>
      ...
      <v-col cols="8">
        <v-sheet color="secondary" min-height="800" class="pa-4 discover-list" rounded>
          <ul class="white--text">
            <li class="d-flex align-center pa-2" style="height:80px;" v-for="(track,index) in filterItems" :key="index">
              ...
              <div class="d-flex align-center">
                ...
                <v-btn :color="myLikes.includes(track._id) ? 'red' : 'white'" rounded outlined class="mx-1">
